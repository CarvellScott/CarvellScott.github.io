---
layout: post
title: "Bash completion with Python"
excerpt: Making bash completion more sufferable
tags: tutorial, linux, unix, completion, python
---

*the following has been adapted from the [original post](https://github.com/CarvellScott/completion_utils)*
...
Summarized, you need to make a program that accepts three command-line arguments, (maybe four environment variables too), and prints stuff that matches one of the parameters to stdout. Easy enough. Here's a template in Python:
